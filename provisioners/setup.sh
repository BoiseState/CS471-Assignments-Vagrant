...
# the <folder of cloned CS471-Assignments-Vagrant> folder on the host machine
...
# NOTE: The file <folder of cloned CS471-Assignments-Vagrant>/start_server.sh on the host machine will automatically be
